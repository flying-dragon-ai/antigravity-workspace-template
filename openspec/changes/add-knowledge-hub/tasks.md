...
- [x] 0.2 Rename `engine/src/` to `engine/repobrain_engine/` and update all imports
...
- [x] 1.1 Update `.repobrain/` templates (rules.md, conventions.md, decisions/.gitkeep, memory/.gitkeep, .version)
...
- [x] 1.4 Add offline CLI commands (rb report, rb log-decision)
...
- [x] 2.4 Add CLI commands calling Engine (rb ask, rb refresh, rb start-engine refactor)
