...
Markdown content written to ``.repobrain/structure.md``.
...
def extract_structure(root: Path) -> str:
    ...
    suitable for writing to ``.repobrain/structure.md``.
    ...
    """
    from repobrain_engine.hub.scanner import _find_venv_dirs, _should_skip
    ...
    header = "# Project Structure Map\n\nAuto-generated by `rb refresh`. Do not edit manually.\n"
    return header + "\n\n".join(sections)
