...
into repobrain_engine/tools/ and it becomes available to the agent automatically.
"""
...
def greet_user(name: str) -> str:
    ...
    """
    return f"Hello, {name}! 🎉 Welcome to the RepoBrain Agent with dynamic tool loading!"
