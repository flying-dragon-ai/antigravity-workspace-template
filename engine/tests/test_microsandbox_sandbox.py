...
from repobrain_engine.sandbox.microsandbox_exec import MicrosandboxSandbox
...
def test_microsandbox_server_unavailable(monkeypatch) -> None:
    ...
    with patch(
        "repobrain_engine.sandbox.microsandbox_exec.requests.post",
...
def test_microsandbox_success_execution(monkeypatch) -> None:
    ...
    with patch("repobrain_engine.sandbox.microsandbox_exec.requests.post", side_effect=responses):
...
def test_microsandbox_timeout(monkeypatch) -> None:
    ...
    with patch("repobrain_engine.sandbox.microsandbox_exec.requests.post", side_effect=_post_with_timeout):
